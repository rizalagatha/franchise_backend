...
router.get(
  "/",
  [verifyToken, injectBranchDb, checkPermission(PEMBELIAN_MENU_ID, "view")],
...
router.delete(
  "/:nomor",
  [verifyToken, injectBranchDb, checkPermission(PEMBELIAN_MENU_ID, "delete")],
...
router.get(
  "/form/:nomor",
  [verifyToken, injectBranchDb, checkPermission(PEMBELIAN_MENU_ID, "edit")],
...
router.post(
  "/save",
  [verifyToken, injectBranchDb, checkSavePermission(PEMBELIAN_MENU_ID)],
...
router.get(
  ...
  [verifyToken, injectBranchDb, checkPermission(PEMBELIAN_MENU_ID, "insert")], // Perlu izin insert
